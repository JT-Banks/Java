...
public class Prog05_Scramble {
	...
	public static void main(String[] args) {
        ...
        do {
            ...
            word = in.next();
            while (userDone) {  //Statement to check yes or no
                if (word.equals("y")) {
                    ...
                    System.out.println("Invalid input, please enter more than 3 letter words."); //If the word is 3 letters or less, the logic doesn't flow
                }
            }
